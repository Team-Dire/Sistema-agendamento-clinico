...
public class UIConsultasMedico extends javax.swing.JDialog {
     ...
     */
    public UIConsultasMedico(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void btnVerificarPacienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVerificarPacienteActionPerformed
        ...
        ArrayList<Consulta> consultasHoje = ControladorConsulta.getConsultasMedico(this.inputNomeMedico.getText());
